 ...
 *         &lt;element name="companies" type="{https://soupaulodev.com.br/feedback}companyList"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ListCompaniesResponse")
public class ListCompaniesResponse {

    @XmlElement(required = true)
    protected String operationStatus;
    @XmlElement(required = true)
    protected CompanyList companies;
     ...
     *     
     */
    public void setCompanies(CompanyList value) {
